    ...
    <body>
		...
		<div id = "main_wrapper">
			...
			<div class = "center-column">
				...
				<nav class = "not-fixed">
					<ul>
						<li><a id = "our_work" class = 'inactive' href = "our_work.php" rel="address:/our_work"><span>See Our</span> Work</a></li>
						<li><a id = "culture" class = 'inactive' href = "culture.php" rel="address:/culture"><span>The VIAn</span> Culture</a></li>
						<li><a id = "news" class = 'inactive' href = "news.php" rel="address:/news"><span>In The</span> News</a></li>
						<li><a id = "contact" class = 'inactive' href = "contact.php" rel="address:/contact"><span>Make</span> Contact</a></li>
					</ul>
				</nav>
